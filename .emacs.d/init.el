...
(global-set-key (kbd "C-s") 'save-buffer) ;;  switching between buffers
...
(global-set-key (kbd "C-c s") (kbd "M-a shell RET"))
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(hungry-delete helm-pydoc fill-column-indicator ace-window org-pdftools org-noter pdf-tools solarized-theme magit ein flycheck iedit yasnippet-snippets elpy material-theme))
